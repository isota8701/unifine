...
if __name__ == "__main__":
    ...
    # curate_eval()
    # check_history('checkpoints/history_noem_wos_pretrain_0417_materials-project_77153.pickle')
    # plot_history('checkpoints/history_EM_source_pretrain_0410_materials-project_90543.pickle')